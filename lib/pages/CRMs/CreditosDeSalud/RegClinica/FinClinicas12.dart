...
class FinClinicas12 extends StatefulWidget {
  const FinClinicas12({super.key});

  @override
  State<FinClinicas12> createState() => _FinClinicas12State();
}

class _FinClinicas12State extends State<FinClinicas12> {
  ...
  Widget build(BuildContext context) {
    return MyCustomFormFinClinicas12();
    // return Scaffold(
    //   appBar: AppBar(
    ...
    //   body: const MyCustomFormFinClinicas12(),
    // );
  }
}

// Create a Form widget.
class MyCustomFormFinClinicas12 extends StatefulWidget {
  const MyCustomFormFinClinicas12({super.key});

  @override
  MyCustomFormFinClinicas12State createState() {
    return MyCustomFormFinClinicas12State();
  }
}
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => FinClinicas14()));
        },
      ),
    );
  }
