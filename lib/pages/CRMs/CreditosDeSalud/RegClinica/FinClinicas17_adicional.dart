...
class FinClinicas17_adicional extends StatefulWidget {
  const FinClinicas17_adicional({super.key});

  @override
  State<FinClinicas17_adicional> createState() => _FinClinicas17_adicionalState();
}

class _FinClinicas17_adicionalState extends State<FinClinicas17_adicional> {
  ...
  Widget build(BuildContext context) {
    return MyCustomFormFinClinicas17_adicional();
    // return Scaffold(
    //   appBar: AppBar(
    ...
    //   body: const MyCustomFormFinClinicas17_adicional(),
    // );
  }
}

// Create a Form widget.
class MyCustomFormFinClinicas17_adicional extends StatefulWidget {
  const MyCustomFormFinClinicas17_adicional({super.key});

  @override
  MyCustomFormFinClinicas17_adicionalState createState() {
    return MyCustomFormFinClinicas17_adicionalState();
  }
}

class MyCustomFormFinClinicas17_adicionalState
    extends State<MyCustomFormFinClinicas17_adicional> {
