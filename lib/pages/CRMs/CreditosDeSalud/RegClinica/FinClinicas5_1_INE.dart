...
import 'FinClinicas5_1_Biom.dart';

class FinClinicas5_1_INE extends StatefulWidget {
  const FinClinicas5_1_INE({super.key});

  @override
  State<FinClinicas5_1_INE> createState() => _FinClinicas5_1_INEState();
}

class _FinClinicas5_1_INEState extends State<FinClinicas5_1_INE> {
  ...
  Widget build(BuildContext context) {
    return MyCustomFormFinClinicas5_1_INE();
    // return Scaffold(
    //   appBar: AppBar(
...
class MyCustomFormFinClinicas5_1_INE extends StatefulWidget {
  const MyCustomFormFinClinicas5_1_INE({super.key});

  @override
  MyCustomFormFinClinicas5_1_INEState createState() {
    return MyCustomFormFinClinicas5_1_INEState();
  }
}

class MyCustomFormFinClinicas5_1_INEState
    extends State<MyCustomFormFinClinicas5_1_INE> {
  ...
  void Ingresar(Pantalla, IDClinica, Uint8List imageBytes) async {
    try {
      ...
      if (filename != "") {
        ...
        final dio = Dio();
        var url = "https://fasoluciones.mx/api/Clinica/Agregar";

        final formData = FormData.fromMap({
          'Pantalla': 'FinClinicas5_1',
          'SubPantalla': 'FinClinicas5_1_INE',
        ...
        Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (_) => FinClinicas5_1_Biom()));
        FocusScope.of(context).unfocus();

        // request.fields['Pantalla'] = 'FinClinicas5_1_INE';
        // request.fields['SubPantalla'] = 'FinClinicas5_1_INEAtras';
        // request.fields['id_clinica'] = IDClinica;
        // request.fields['id_info'] = IDInfo;
  ...
  Future<void> enviarINE(var ine, IDClinica) async {
    dev.log("enviando--...");
    dev.log(IDClinica.toString());
    // dev.log(ine);
            ...
            if (_fadResponse == "") {
              ...
              if (_formKey.currentState!.validate()) {
                ...
                if (PantallaRecibe == "" ||
                  ...
                  Ingresar(PantallaRecibe, IDClinicaRecibe, globalimageUpdate!);
                }
              }
            }
          },
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => FinClinicas5_1_Biom()));
        },
      ),
    );
  }
