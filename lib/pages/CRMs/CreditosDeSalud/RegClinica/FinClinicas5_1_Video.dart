...
import 'FinClinicas5.dart';

class FinClinicas5_1_Video extends StatefulWidget {
  const FinClinicas5_1_Video({super.key});

  @override
  State<FinClinicas5_1_Video> createState() => _FinClinicas5_1_VideoState();
}

class _FinClinicas5_1_VideoState extends State<FinClinicas5_1_Video> {
  ...
  Widget build(BuildContext context) {
    return const MyCustomFormFinClinicas5_1_Video();
    // return Scaffold(
    //   appBar: AppBar(
...
class MyCustomFormFinClinicas5_1_Video extends StatefulWidget {
  const MyCustomFormFinClinicas5_1_Video({super.key});

  @override
  MyCustomFormFinClinicas5_1_VideoState createState() {
    return MyCustomFormFinClinicas5_1_VideoState();
  }
}

class MyCustomFormFinClinicas5_1_VideoState
    extends State<MyCustomFormFinClinicas5_1_Video> {
  ...
  void Ingresar(Pantalla, IDClinica, Uint8List videoBytes) async {
    try {
      final dio = Dio();
      var url = "https://fasoluciones.mx/api/Clinica/Agregar";
      final formData = FormData.fromMap({
        'Pantalla': 'FinClinicas5_1',
        'SubPantalla': 'FinClinicas5_1_Video',
      ...
      // // request.fields['Pantalla'] = 'FinClinicas5_1_Video';
      // // request.fields['SubPantalla'] = 'FinClinicas5_1_VideoInfo';
      ...
      //   //     MaterialPageRoute(builder: (_) => FinClinicas5_1INE()));
      // }
  ...
  void consultar_Texto() async {
    ...
    Pantalla.text = 'FinClinicas5_1_Video';
    IDClinica.text = "$id_clinica";
    Consultar("$id_clinica");
  }
