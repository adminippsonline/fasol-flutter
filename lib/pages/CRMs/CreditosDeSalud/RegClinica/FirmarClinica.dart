...
import 'FirmarClinica.dart';

class FirmarClinica extends StatefulWidget {
  const FirmarClinica({super.key});

  @override
  State<FirmarClinica> createState() => _FirmarClinicaState();
}

class _FirmarClinicaState extends State<FirmarClinica> {
  ...
  Widget build(BuildContext context) {
    return MyCustomFormFirmarClinica();
    // return Scaffold(
    //   appBar: AppBar(
...
class MyCustomFormFirmarClinica extends StatefulWidget {
  const MyCustomFormFirmarClinica({super.key});

  @override
  MyCustomFormFirmarClinicaState createState() {
    return MyCustomFormFirmarClinicaState();
  }
}

class MyCustomFormFirmarClinicaState extends State<MyCustomFormFirmarClinica> {
  ...
  String ticket = "";
  String msg = "";
  void Consultar(IDClinica, IDInfo) async {
    /*print("****-------------------**********************");
    print(IDClinica);
    print(IDInfo);
    print("****-------------------**********************");*/
    if (IDClinica != 0 && IDInfo != 0) {
      try {
        var url = Uri.https('fasoluciones.mx', 'ApiApp/Clinica/FirmarFAD.php');
        var data = {
          'Pantalla': 'Firmar',
