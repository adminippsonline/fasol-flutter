...
class _FinRegMedico30State extends State<FinRegMedico30> {
  ...
  Widget build(BuildContext context) {
    return MyCustomFormFinRegMedico30();
  }
}
...
class MyCustomFormFinRegMedico30State
  ...
  Widget build(BuildContext context) {
    return BuildScreens(
        'Médico', '', '', 'Información Personal', '', _formulario());
  }
    ...
    return Form(
        ...
        child: SingleChildScrollView(
          child: Column(
              ...
              children: <Widget>[
                // headerTop("Médicos", 'Información personal'),
                SubitleCards("Datos básicos"),
                const SizedBox(
                  height: 20,
                ),
                Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => FinRegMedico30_1()));
        },
      ),
    );
  }
