...
class FinRegMedico35_Biom extends StatefulWidget {
  const FinRegMedico35_Biom({super.key});

  @override
  State<FinRegMedico35_Biom> createState() => _FinRegMedico35_BiomState();
}

class _FinRegMedico35_BiomState extends State<FinRegMedico35_Biom> {
  ...
  Widget build(BuildContext context) {
    return MyCustomFormFinRegMedico35_Biom();
    // return Scaffold(
    //   appBar: AppBar(
...
class MyCustomFormFinRegMedico35_Biom extends StatefulWidget {
  const MyCustomFormFinRegMedico35_Biom({super.key});

  @override
  MyCustomFormFinRegMedico35_BiomState createState() {
    return MyCustomFormFinRegMedico35_BiomState();
  }
}

class MyCustomFormFinRegMedico35_BiomState
    extends State<MyCustomFormFinRegMedico35_Biom> {
  ...
  void Ingresar(Pantalla, IDMedico) async {
    try {
      final req = {
        ...
        'SubPantalla': 'FinSolicitar35_BiomUno',
        'id_medico': IDMedico,
      ...
      if (status == "OK") {
        ...
        /*Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (_) => FinRegMedico35_Video()));*/
      }
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        if (_fadResponse == "") {
                          ...
                          //   // enviarINE(bytes, id_medico, id_info);

                          //   //ESTE ES EL BUENO
                          //   //enviarINE(j['data'].toString(), id_medico, id_info);
                          // }
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => FinRegMedico35_Video()));
        },
      ),
    );
  }
